...
public class OwSomnibarkLogBlock extends RotatedPillarBlock implements NightEmissiveBlockBase {
    public OwSomnibarkLogBlock(BlockBehaviour.Properties properties) {
        super(properties);
        this.registerDefaultState(defaultNightState(this.stateDefinition.any()).setValue(AXIS, net.minecraft.core.Direction.Axis.Y));
    }
